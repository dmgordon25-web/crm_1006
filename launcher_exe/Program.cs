...
{
    private const string MutexName = "Local\\CRM_vFinal_EXE_Singleton";
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            var runLog = Files.NewRunLog();
            logWriter = new StreamWriter(runLog, append: false, Encoding.UTF8) { AutoFlush = true };
            ...
            Files.WriteStateUrl(landingUrl);
...
internal static class Files
{
    ...
    public static void WriteStateUrl(string url)
    {
